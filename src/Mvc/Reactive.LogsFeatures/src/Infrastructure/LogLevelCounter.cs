...
namespace EquipApps.Mvc.Reactive.LogsFeatures.Infrastructure
{
    ...
    public class LogLevelCounter : IObservable<LogLevelCount>, IDisposable
    {
        ...
        private void OnNext(LogEntry logEntry)
        {
            ...
            {
                case LogEntryLevel.dbug: countdbug++; break;
                case LogEntryLevel.info: countinfo++; break;
                case LogEntryLevel.warn: countwarn++; break;
                case LogEntryLevel.fail: countfail++; break;
                default:
                    break;
            }
        }
