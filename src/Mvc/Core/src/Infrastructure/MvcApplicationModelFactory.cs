...
namespace NLib.AtpNetCore.Mvc.Internal
{
    ...
    public class MvcApplicationModelFactory : IApplicationModelFactory
    {
        private readonly IApplicationModelProvider[] _providers;
        private readonly ILogger<MvcApplicationModelFactory> logger;

        ApplicationModel applicationModel;


        public MvcApplicationModelFactory(
            ILogger<MvcApplicationModelFactory> logger,
