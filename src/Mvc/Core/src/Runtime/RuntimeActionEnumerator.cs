...
namespace EquipApps.Mvc.Infrastucture
{
    /// <summary>
    /// Реализация <see cref="IRuntimeActionEnumerator"/>.
    /// НЕ потоко безопасна!
    /// </summary>
    public class RuntimeActionEnumerator : IRuntimeActionEnumerator, IDisposable
    {
        ...
        public RuntimeActionEnumerator(IReadOnlyList<ActionDescriptor>  actions)
        {
