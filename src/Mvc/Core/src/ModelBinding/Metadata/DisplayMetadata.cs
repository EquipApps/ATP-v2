...
namespace EquipApps.Mvc.ModelBinding.Metadata
{
    ...
    public class DisplayMetadata
    {
        ...
        /// <summary>
        /// Gets the names and values of all <see cref="Enum"/> values in
        ...
        /// <see cref="Enum"/>. See <see cref="ModelMetadata.IsEnum"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether <see cref="ModelMetadata.UnderlyingOrModelType"/> is for an
        /// <see cref="Enum"/> with an associated <see cref="FlagsAttribute"/>. See
