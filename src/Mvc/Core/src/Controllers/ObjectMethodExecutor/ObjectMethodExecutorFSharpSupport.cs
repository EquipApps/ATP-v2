...
namespace NLib.AtpNetCore.Testing.Mvc.Controllers
{
    ...
    internal static class ObjectMethodExecutorFSharpSupport
    {
        ...
        {
            var methodReturnGenericType = possibleFSharpAsyncType.GetTypeInfo().IsGenericType
            ...
            var awaiterResultType = possibleFSharpAsyncType.GetTypeInfo().GenericTypeParameters.Single();
        ...
        private static bool IsFSharpAsyncOpenGenericType(Type possibleFSharpAsyncGenericType)
        {
            ...
            lock (_fsharpValuesCacheLock)
            {
                if (_fsharpCoreAssembly != null)
                {
                    ...
                    return possibleFSharpAsyncGenericType.GetTypeInfo().Assembly == _fsharpCoreAssembly;
                }
                else
                {
        ...
        {
            var assembly = possibleFSharpAsyncGenericType.GetTypeInfo().Assembly;
        ...
        {
            return type1.GetTypeInfo().Assembly == type2.GetTypeInfo().Assembly
