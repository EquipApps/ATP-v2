...
namespace EquipApps.Hardware.Behaviors.Digital.Tests
{
    ...
    public class DigitalPort8Tests2
    {
        ...
        public void RequestToUpdateValueTM()
        {
            ...
            var behavior1 = new MocValue();
            behavior1.ValueUpdate += (object sender, ValueBehaviorContext<byte> context) =>
            {
                count1++;
            ...
            var behavior3 = new MocValue();
            behavior3.ValueUpdate += (object sender, ValueBehaviorContext<byte> context) =>
            {
                count3++;

                //-- Значение установлено
                context.SetOutput(30);
            };
