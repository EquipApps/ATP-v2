...
namespace EquipApps.Hardware.Abstractions.Tests
{
    ...
    public class ValueBehaviorTests
    {
        ...
        public void RequestToChangeValueT1()
        {
            ...
            var behavior = new MocValue();
            behavior.ValueChange += (ValueBehaviorContext<int> context) =>
            {
                Assert.AreEqual(10, context.Input);
                countCall++;
                    //-- Не обрабатываем
        ...
        public void RequestToUpdateValueT1()
        {
            ...
            var behavior = new MocValue();
            behavior.ValueUpdate += (ValueBehaviorContext<int> context) =>
            {
                Assert.AreEqual(-1, context.Input);
                countCall++;
                //-- Не обрабатываем
        ...
        public void RequestToChangeValueTM()
        {
            ...
            var behavior1 = new MocValue();
                behavior1.ValueChange += (ValueBehaviorContext<int> context) =>
                {
                    count1++;
            ...
            var behavior2 = new MocValue();
                behavior2.ValueChange += (ValueBehaviorContext<int> context) =>
                {
                    count2++;
            ...
            var behavior3 = new MocValue();
                behavior3.ValueChange += (ValueBehaviorContext<int> context) =>
                {
                    count3++;
